  ...
  <div
    ...
    <div class="space-y-4">
      <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-800">
        <span class="text-xs md:text-sm text-gray-700 dark:text-gray-300">Network Fee (Gas Fee)</span>
      ...
      <div class="flex justify-between items-center py-2">
        <span class="text-xs md:text-sm text-gray-700 dark:text-gray-300">Estimated Time</span>
      ...
      <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
        <div class="flex justify-between items-center">
          ...
          <span class="text-base md:text-lg font-bold text-blue-600 dark:text-blue-400">{{ formatNumber(amount) }}
            WCH</span>
        </div>
