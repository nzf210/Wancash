<template>
  <div class="space-y-6">
    ...
    <div
      ...
      <div class="relative">
        <img :src="localUser.avatar" alt="Foto Profil"
      ...
      <div class="flex-1">
        ...
        <p class="text-sm text-muted-foreground/70 mt-1">Bergabung {{ localUser.joinDate }}</p>
      </div>
    </div>
      ...
      <div class="space-y-4">
        <div>
          ...
          <Textarea id="bio" v-model="localUser.bio"
            ...
            placeholder="Ceritakan sedikit tentang diri Anda" rows="4" :maxlength="200" />
          <p class="text-xs text-muted-foreground mt-1">
            {{ localUser.bio.length }}/200 karakter
          </p>
        </div>

        <div>
          <Label for="role" class="text-foreground">Peran</Label>
