...
task('lz:oft:sendx', 'Sends OFT tokens cross‐chain from EVM chains')
    ...
    .setAction(async (args: MasterArgs, hre: HardhatRuntimeEnvironment) => {
        ...
        // Di task lz:oft:send sebelum quoteSend
        // console.log('Active Config:', await hre.deployments.get('MyOFTMock'))
        // console.log('EndpointV2 Address:', await hre.deployments.get('EndpointV2'))
        if (args.oftAddress) {
