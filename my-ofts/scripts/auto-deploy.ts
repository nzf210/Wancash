...
// Paths
const envMode = process.env.ENV || (config.mode === 'prod' ? 'prod' : 'dev')
const OFT_ENV_PATH = path.resolve(__dirname, `../.env.${envMode}`)
console.log('Logs For OFT_ENV_PATH + ', OFT_ENV_PATH, dotenv.config({ path: OFT_ENV_PATH }))
